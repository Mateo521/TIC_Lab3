...
//SELECCIONAR ARCHIVO PARA DFSCOMPACTAR
    public static void SelectArchivo() {
        ...
        FileNameExtensionFilter filtro = new FileNameExtensionFilter("Archivos HUF ,DC y DE", "huf", "DC1", "DC2", "DC3", "DE1", "DE2", "DE3");
        ...
        if (select == JFileChooser.APPROVE_OPTION) {
            ...
            if (!controlExtensionSalida(ex)) {
                JOptionPane.showMessageDialog(
                        null,
                        "Debe seleccionar un archivo con extensión válida: .huf, .DC1, .DC2 o .DC3",
                        "Extensión inválida",
